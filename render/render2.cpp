...
#include "render2.h"
  ...
  */
void v_max(float max[3], const std::vector<Vector>& V, int vertices)
{
 ...
 * vertices: The amount of vertices in the input file
 */
void v_min(float min[3], const std::vector<Vector>& V, int vertices)
{
 ...
 */
void find_vector(float v[3], const std::vector<Vector>& table, int index)
{
	v[0] = table[index].a;
	v[1] = table[index].b;
	v[2] = table[index].c;
